...
### Docs (MkDocs, Material theme, i18n zh/en)
```bash
mkdocs serve          # local preview (requires mkdocs-material + mkdocs-static-i18n)
...
- `site/` — pre-built MkDocs output; `build/` — PX4 build output (both generated).
