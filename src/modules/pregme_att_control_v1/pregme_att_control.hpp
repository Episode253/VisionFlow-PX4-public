...
private:
	...
	DEFINE_PARAMETERS(
		...
		(ParamFloat<px4::params::MASS_UAV_AT>) _param_usr_mass_uav,
		(ParamFloat<px4::params::MASS_MANIP_AT>) _param_usr_mass_manip,
		...
		(ParamFloat<px4::params::MAN_Y_MAX_AT>) _param_usr_man_y_max,

		(ParamInt<px4::params::USR_AIRMODE>) _param_usr_airmode,
		(ParamFloat<px4::params::USR_MAN_TILT_TAU>) _param_usr_man_tilt_tau,
		(ParamFloat<px4::params::TILT_MAX_AT>) _param_usr_man_tilt_max,
		(ParamFloat<px4::params::MANTHR_MIN_AT>) _param_usr_manthr_min,
		(ParamFloat<px4::params::THR_MAX_AT>) _param_usr_thr_max,
		(ParamFloat<px4::params::THR_HOVER_AT>) _param_usr_thr_hover,
		(ParamInt<px4::params::THR_CURVE_AT>) _param_usr_thr_curve,
