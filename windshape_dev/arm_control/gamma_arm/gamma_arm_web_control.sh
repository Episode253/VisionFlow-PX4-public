...
# Source ROS2 in Docker container if available
...
URL="http://${WEB_HOST}:${WEB_PORT}/index_gamma.html"
...
if [[ ! -f "${SCRIPT_DIR}/index_gamma.html" ]]; then
  echo "[WARN] index_gamma.html was not found in:"
  echo "       ${SCRIPT_DIR}"
...
echo ""
echo "GAMMA Arm Web control panel:"
echo "  ${URL}"
echo ""
